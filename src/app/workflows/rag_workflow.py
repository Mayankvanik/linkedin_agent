...
from src.app.nodes_and_edges.nodes.llm_node import llm_node
...
def search_online(state: AgentState):  # Default search depth if not specified
    ...
    try:
        ...
        print('➡ state[ searchhhhh:', state["context"])
...
def create_rag_graph():
    ...
    workflow.add_edge("first_social-media_prompt", "llm_node")
    ...
    workflow.set_entry_point("first_social-media_prompt")
